  ...
  <div class="flex-1 flex">
    ...
    <div class="flex-1 flex flex-col border-color">
      ...
      <div class="px-3 py-1 flex border-b border-color">
        ...
        <div>
          <div class="font-semibold text-lg">jajgn.com</div>
      ...
      <div class="bg-gray-300 h-40 relative">
        ...
        >
          <img
            ...
            class="rounded-full opcaity-90 hover:opacity-100 cursor-pointer"
          />
        </div>
      </div>
      <!-- profile edit button -->
      <div class="text-right mt-2 mr-2">
        <button
          class="border-2 text-sm border-primary text-primary px-3 py-1 hover:bg-blue-50 font-bold rounded-full"
        >
          프로필 수정
        </button>
      </div>
      <!-- user info -->
      <div class="mx-3 mt-2">
        <div class="font-extrabold text-lg">jhjang.com</div>
        <div class="text-gray">@jhjang</div>
        <div>
      ...
      <div class="flex border-b border-color mt-3">
        <div
          class="py-3 text-primary font-bold border-b border-primary text-center w-1/4 hover:bg-blue-50 cursor-point hover:text-priamry"
        >
          트윗
        </div>
        <div
          class="py-3 text-gray font-bold text-center w-1/4 hover:bg-blue-50 cursor-point hover:text-priamry"
        >
          트윗 및 답글
        </div>
        <div
