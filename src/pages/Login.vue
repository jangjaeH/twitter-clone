<template>
    <div class="flex flex-col items-center space-y-4 mt-10">
        ...
        <input
            ...
            placeholder="비밀번호"
        />
        <button v-if="loading" class="w-96 bg-light text-white py-3">로그인 중입니다.</button>
        <button v-else class="w-96 bg-primary text-white py-3 hover:bg-dark" @click="onLogin">로그인</button>
