          ...
          <div>
            <div>
              <div class="flex space-x-1">
                <div class="font-bold">jhjang.com</div>
                <div class="text-gray-500">@jhjang</div>
    ...
    <div class="w-3/5 border-r border-gray-100">
      <div class="flex flex-col h-screen">
        ...
        <div class="flex px-3 h-14 items-center border-b border-gray-100">
          ...
          />
          <div>
            <div class="font-bold text-lg">jhjang.com</div>
            <div class="text-sm text-gray-500">@jhjang</div>
          </div>
        </div>
        <!-- user info -->
        <div
          class="flex flex-col justify-cneter items-center border-b border-gray-100 hover:bg-gray-50 py-6"
        >
          <div>
            <span class="font-bold mr-1">jhjang.com</span>
            <span class="text-gray-500">@jhjang</span>
          </div>
          <div>
        ...
        <div class="flex items-center bg-white border-gray-100 sticky">
          <input
            type="text"
            class="m-2 my-1 px-4 rounded-full bg-gray-100 resize-none outline-none flex-1"
            placeholder="새 쪽지 작성하기"
          />
          <button class="text-cneter">
            <i
